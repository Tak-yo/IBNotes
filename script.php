     ...
     */
     ...
     function sendMail($name, $email, $subject, $message){
        ...
        */
        ...
        /*
            By setting SMTPSecure to PHPMailer:: ENCRYPTION_STARTTLS, we are
            telling PHPMailer to use the STARTTLS encryption method when connecting to the SMTP server.
            This helps encure that the communication between your PHP application
            and the SMTP server is encrpyted, adding a layer of security to your
        ...
        */
        ...
        /*
            The 'addReplyTo' property specifics where the recipient can reply to.
        ...
        */
        ...
        /*
            Assigning name to the $mail->name property.
        */
        $mail->FromName = $name;
        ...
        */
        ...
        /*
            When we set $mail->AltBody, we are providing a plain text alernative
            to the HTML version of our email.
            This is important for compatibility with emnail clients that may not support
